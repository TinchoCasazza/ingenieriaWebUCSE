    ...
    Imgur.prototype = {
        ...
        createDragZone: function () {
            var p1, p2, input;
                ...
                p1 = this.createEls('p', {}, 'Arrastra la Imagen acá');
                p2 = this.createEls('p', {}, 'O haga Click para seleccionar una foto');
        ...
        loading: function () {
            ...
            img = this.createEls('img', {className: 'loading-image', src: 'django_adminlte/static/cargarImagen/css/loading-spin.svg'});
